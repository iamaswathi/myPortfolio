        ...
        <div className="container">
          <div className="row sectionSeparator">
            ...
            <blockquote className="experienceItem">
              ...
              to be very clear and never settle for less when it comes to quality in
              the given task. She used to be very innovative and creative in the work.
            ...
            <blockquote className="experienceItem">
              ...
              developer is because she gives a huge importance to thorough unit testing
              and constantly updating her with the latest in her technology. Even after
              having left the organization the team doesn't face any difficulty since
