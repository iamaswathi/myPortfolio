...
export default class Timeline extends Component {
  render() {
    return (
      <section class="darkContainer" id="ExperienceSec">
      <div class="container">
        <div class="row sectionSeparator">
          <div class="col-sm-12 col-md-6">
            ...
            <div class="experienceItem">
              ...
              <div class="expYear">2016-2020</div>
              <p>Worked on projects like building a mobile Banking application and TAX& TIN Compliance 
                ...
                CSS3. </p>
              <p><i class="fa fa-envelope"></i>Emerged as a global finalist in the FinTech hackathon organised by FIS by demonstrating
            ...
            <div class="experienceItem">
              ...
              <div class="expYear">2012-2016</div>
          ...
          <div class="col-sm-12 col-md-6">
            ...
            <div class="experienceItem">
              ...
              <div class="eduYear">2008-2012</div>
            ...
            <div class="experienceItem">
              ...
              <div class="eduYear">2006-2008</div>
              <p>It is a long established fact that a reader will be distracted by the readable content of a 
              page when looking at its layout. The point of using  Lorem Ipsum </p>
            </div>
          </div>
